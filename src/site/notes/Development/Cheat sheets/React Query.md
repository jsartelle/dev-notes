...
- can be used alongside a client-side state manager like Redux or [[Development/Cheat sheets/MobX\|MobX]], but if most of your state is asynchronous data from a server, it's simpler to just use React Query
