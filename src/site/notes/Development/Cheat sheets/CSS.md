...
<div style="display: flex">
    <div style="height: 100px; width: 100px; margin: 16px; border: 1px solid currentColor; box-shadow: 0 0 16px 0 currentColor;">no clip-path</div>
    <div style="height: 100px; width: 100px; margin: 16px; border: 1px solid currentColor; box-shadow: 0 0 16px 0 currentColor; clip-path: inset(0 0 -16px 0);">clip-path</div>
</div>
...
- enlarges an element and affects layout (unlike `transform` or `scale`)
...
- in the example below, the square with `zoom` affects layout, so its container expands to fit it, while the square with `scale` doesn't
