---
{"dg-publish":true,"dg-path":"Cheat sheets/SQL cheat sheet.md","permalink":"/cheat-sheets/sql-cheat-sheet/","tags":["tech/databases"]}
---
...
- Also see [[Development/Cheat sheets/SQL cheat sheet#Count number of distinct values\|#Count number of distinct values]] and [[Development/Cheat sheets/SQL cheat sheet#GROUP BY\|#GROUP BY]]
...
- since JSON object keys are always strings, if you used [[Development/Cheat sheets/SQL cheat sheet#JSON_KEYS\|#JSON_KEYS]] to get the array, you may need to [[Development/Cheat sheets/SQL cheat sheet#CAST\|cast]] the value being checked to a string
...
- WHERE cannot be used with [[Development/Cheat sheets/SQL cheat sheet#Aggregate functions (COUNT, MAX, MIN, SUM, AVG)\|aggregate functions]], use HAVING instead
...
- Often used in queries with [[Development/Cheat sheets/SQL cheat sheet#Aggregate functions (COUNT, MAX, MIN, SUM, AVG)\|aggregate functions]] to analyze each group of rows
...
- To fix this, use an [[Development/Cheat sheets/SQL cheat sheet#Aggregate functions (COUNT, MAX, MIN, SUM, AVG)\|aggregate function]]
...
- MySQL does not let you combine [[Development/Cheat sheets/SQL cheat sheet#UPDATE / SET\|UPDATE]] and [[Development/Cheat sheets/SQL cheat sheet#LIMIT / OFFSET\|#LIMIT / OFFSET]], this can be used to get around that
...
- Get a JSON array from the keys of a JSON object
    - see [[Development/Cheat sheets/SQL cheat sheet#MEMBER_OF (in JSON array)\|MEMBER_OF]] to use it in a WHERE or JOIN
...
- To handle [[Development/Cheat sheets/SQL cheat sheet#Dates & Times\|dates]] or datetimes:
